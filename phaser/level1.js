...
function preload() {
    this.load.image('tiles', '/phaser/assets/tiles.png');
    this.load.tilemapTiledJSON('map', '/phaser/assets/untitled.json');
    this.load.spritesheet('heart', '/phaser/assets/heart.png', { frameWidth: 8, frameHeight: 8 }, '/phaser/heart.json');
    this.load.image('spark', '/phaser/assets/spark.png');
    this.load.audio('soundtrack', '/phaser/assets/soundtrack.opus');
}
