...
written in vscode, [stored in github](https://github.com/novedevo/nove.dev), generated by zola, and hosted on cloudflare. i use software in the small for fun, but for things i want to last a long time without payment or maintenance, megacorps appear to be the only solution at the moment. [considering](/blog/hosting) other options. maybe i'll be on grebedoc next time you check?

javascript is not required to use this site. there's an iframe with the katamari damacy soundtrack on one of my blogposts, that's all.
